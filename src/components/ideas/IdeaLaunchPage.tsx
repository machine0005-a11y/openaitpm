...
// A palette of bold gradient themes. Each idea is deterministically assigned one
// from its slug, so every page feels distinct and colorful but stays consistent
// across reloads.
const THEMES = [
